...
def plot_(evaluar_indice, steps_list=None, rango=(-8, 8), resolucion=50, nombre_archivo="BL"):
    """
    ...
    # --- Mostrar figura ---
    fig.write_html(f"12- Laboratorio de Implementación/{nombre_archivo}.html")
    print(f"Gráfica guardada como '12- Laboratorio de Implementación/{nombre_archivo}.html'")
    #fig.show()
